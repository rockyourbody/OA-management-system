						...
						<el-form ref="form" :model="student_item" label-width="100px">
							<div>
								<div>
									...
									<el-form-item label="状态">
										<el-select v-model="student_item.enter_class" placeholder="请选择状态">
											<el-option label="预报名" value="1"></el-option>
											<el-option label="在读" value="2"></el-option>
											<el-option label="毕业" value="3"></el-option>
											<el-option label="已就业" value="4"></el-option>
											<el-option label="休学" value="5"></el-option>
											<el-option label="退学" value="6"></el-option>
										</el-select>
									</el-form-item>
